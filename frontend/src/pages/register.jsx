...
function RegisterScreen() {
  ...
  return (
    <div className="min-vh-100 d-flex flex-column align-items-center justify-content-center bg-light position-relative">
      ...
      <div className="w-100 p-2 d-block d-md-none">
        <button
          onClick={() => navigate("/")}
      ...
      <div
        ...
        style={{
         borderRadius: "25px",
         maxWidth: "700px",   // más estrecho en desktop
         width: "100%",       // ocupa todo en móvil

         height: window.innerWidth >= 992 ? "9 0vh" : "auto", // desktop limitado, móvil libre
      ...
      >
        <div className="row g-0 h-100">
          ...
          {/* Panel lateral verde */}
          <div className="col-md-4 bg-success d-flex align-items-center justify-content-center p-4 text-white text-center">
            <div>
          ...
          <div className="col-md-8 bg-white">
            <div className="card-body p-1 p-md-5">
              <h2 className="text-center mb-2 text-success fw-bold">Crear Cuenta</h2>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="d-grid">
                  <button
                    type="submit"
                    className="btn btn-success btn-lg fw-bold py-1"
